...
<<>>=
londondata<-read.ymdc('meas_uk__lon_1944-94_wk.csv') #load london time series using function from 1a(i)
plot(londondata$date, londondata$cases)
time.plot(londondata,10,add= TRUE, col='red') #plot using 10 week moving average using function from 1a(ii)
...
periodogram(londondata,as.Date('1950-01-01'),as.Date('1975-01-01'),xlim=c(1,250), main="1950-01-01 to 1975-01-01",xlab="Weeks", ylab="Power") 

periodogram(londondata,as.Date('1975-01-01'),as.Date('1990-01-01'),xlim=c(1,250), main="1975-01-01 to 1990-01-01",xlab="Weeks", ylab="Power")  
@
...
periodogram(londondata,end.date=as.Date('1950-01-01'),xlim=c(1,250), main="Beginning timeseries to 1950-01-01",xlab="Weeks", ylab="Power")
periodogram(londondata,as.Date('1950-01-01'),as.Date('1968-01-01'),xlim=c(1,250), main="1950-01-01 to 1968-01-01",xlab="Weeks", ylab="Power") #strongest 2 year cycle. slightly less strong 1 year cycle
periodogram(londondata,as.Date('1968-01-01'),as.Date('1990-01-01'),xlim=c(1,250), main="1968-01-01 to End of Time Series",xlab="Weeks", ylab="Power")  #strong 3 year cycle. less strong 1 year cycle
...
for (i in 1:4) {
  ...
  plot(SI.Gillespie(beta = params["beta"], 
                       N = params["N"], 
                       I0 = initial["I"], 
                       tmax = tmax), col = 1)
