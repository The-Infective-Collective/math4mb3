...
plot(londondata$date, londondata$cases, xlab="Weeks", ylab="Incidence", main ="10 Week Moving Average Plot of Liverpool Data")
...
plot(lpldata$date, lpldata$cases, xlab="Weeks", ylab="Incidence", main="10 Week Moving Average Plot of Liverpool Data")
...
for (i in 1:4) {
  ...
  plot(as.data.frame(sol), type = "l", lwd = 3, main= str_c("Solution of SI Model for N= ", size))
