...
Note that the approximate solution converges to the $(0,0$ equilibrium instead of the endemic equilibrum. 
...
We note that as time increases, the prevalence curve generated by the SIR model behaves like the linear model in both figures, confirming our prediction. Furthermore, the exponential curve we estimated previously agrees with the peaks of the linear model prevalence curve, again confirming our prediction.
