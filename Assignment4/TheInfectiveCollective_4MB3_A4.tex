...
\begin{alltt}
\hlkwd{library}\hlstd{(tidyverse,stringr)} \hlcom{#load necessary packages}
\end{alltt}


{\ttfamily\noindent\color{warningcolor}{\#\# Warning: package 'tidyverse' was built under R version 3.3.3}}
...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning: package 'tidyr' was built under R version 3.3.3}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning: package 'readr' was built under R version 3.3.3}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning: package 'purrr' was built under R version 3.3.2}}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{periodogram}\hlkwb{<-}\hlkwa{function}\hlstd{(}\hlkwc{df}\hlstd{,} \hlkwc{start.date}\hlstd{=}\hlkwd{as.Date}\hlstd{(df}\hlopt{$}\hlstd{date[}\hlnum{1}\hlstd{]),}\hlkwc{end.date}\hlstd{=}\hlkwd{as.Date}\hlstd{(df}\hlopt{$}\hlstd{date[}\hlkwd{nrow}\hlstd{(df)]),} \hlkwc{add}\hlstd{=}\hlnum{FALSE}\hlstd{,} \hlkwc{...}\hlstd{) \{}
...
\hlkwd{periodogram}\hlstd{(londondata,}\hlkwc{xlim}\hlstd{=}\hlkwd{c}\hlstd{(}\hlnum{0}\hlstd{,}\hlnum{250}\hlstd{),} \hlkwc{main}\hlstd{=}\hlstr{"Entire time series"}\hlstd{)}
\end{alltt}
...
\hlstd{lpldata}\hlkwb{<-}\hlkwd{read.ymdc}\hlstd{(}\hlstr{'meas_uk__lpl_1944-94_wk.csv'}\hlstd{)} \hlcom{#load liverpool time series}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): could not find function "{}str\_c"{}}}\begin{alltt}
\hlkwd{plot}\hlstd{(lpldata}\hlopt{$}\hlstd{date, lpldata}\hlopt{$}\hlstd{cases)}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in plot(lpldata\$date, lpldata\$cases): object 'lpldata' not found}}\begin{alltt}
\hlkwd{time.plot}\hlstd{(lpldata,}\hlnum{10}\hlstd{,}\hlkwc{col}\hlstd{=}\hlstr{'red'}\hlstd{)}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in time.plot(lpldata, 10, col = "{}red"{}): object 'lpldata' not found}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'lpldata' not found}}\begin{alltt}
\hlkwd{periodogram}\hlstd{(londondata,}\hlkwc{end.date}\hlstd{=}\hlkwd{as.Date}\hlstd{(}\hlstr{'1950-01-01'}\hlstd{),}\hlkwc{xlim}\hlstd{=}\hlkwd{c}\hlstd{(}\hlnum{1}\hlstd{,}\hlnum{250}\hlstd{),} \hlkwc{main}\hlstd{=}\hlstr{"Beginning timeseries to 1950-01-01"}\hlstd{,}\hlkwc{xlab}\hlstd{=}\hlstr{"Weeks"}\hlstd{,} \hlkwc{ylab}\hlstd{=}\hlstr{"Power"}\hlstd{)}
\end{alltt}
