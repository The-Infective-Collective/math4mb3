...
% TODO: What R_0 is in this model 
% TODO: Give what $b_0$ and $b_1$ are
% TODO: This model produces an R_0 bifurcation diagram similar to etc
% R_0 = b_0 * N / (gamma + mu) \approx b_0 * N /gamma because mu is so small
