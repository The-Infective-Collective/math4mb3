...
<<fig2save>>==
ggsave("bifurcation.pdf", gbifur, width=6, height=4)
ggsave("probabilitycoherence.pdf", gprob.main, width=6, height = 4)
ggsave("stochastic_illustrate.pdf", gex, width=6, height=4)
ggsave("stochastic.pdf", gstoch, width=6, height=4)
@
