...
\hlkwd{plot}\hlstd{(londondata}\hlopt{$}\hlstd{date, londondata}\hlopt{$}\hlstd{cases,} \hlkwc{xlab}\hlstd{=}\hlstr{"Weeks"}\hlstd{,} \hlkwc{ylab}\hlstd{=}\hlstr{"Incidence"}\hlstd{,} \hlkwc{main} \hlstd{=}\hlstr{"10 Week Moving Average Plot of Liverpool Data"}\hlstd{)}
...
\hlkwd{plot}\hlstd{(lpldata}\hlopt{$}\hlstd{date, lpldata}\hlopt{$}\hlstd{cases,} \hlkwc{xlab}\hlstd{=}\hlstr{"Weeks"}\hlstd{,} \hlkwc{ylab}\hlstd{=}\hlstr{"Incidence"}\hlstd{,} \hlkwc{main}\hlstd{=}\hlstr{"10 Week Moving Average Plot of Liverpool Data"}\hlstd{)}
...
\hlkwa{for} \hlstd{(i} \hlkwa{in} \hlnum{1}\hlopt{:}\hlnum{4}\hlstd{) \{}
  ...
  \hlkwd{plot}\hlstd{(}\hlkwd{as.data.frame}\hlstd{(sol),} \hlkwc{type} \hlstd{=} \hlstr{"l"}\hlstd{,} \hlkwc{lwd} \hlstd{=} \hlnum{3}\hlstd{,} \hlkwc{main}\hlstd{=} \hlkwd{str_c}\hlstd{(}\hlstr{"Solution of SI Model for N= "}\hlstd{, size))}
